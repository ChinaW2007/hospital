...
const fetchData = async () => {
  try {
    ...
    if (!hasData) {
      // Mock data fallback so dashboard is not empty (Placeholder)
      // HIS状态映射: pending(待审核)→显示"待处理处方", approved(已通过)→显示"已发放处方"
      items.value = [
        {
          id: 1,
          prescription_id: 10081,
          prescription_code: "012026062901",
          patient_name: "张伟",
          doctor_name: "林医生",
          medicine_name: "阿莫西林胶囊",
          quantity: 2,
          prescription_status: "pending", // HIS待审核状态 → 显示"待处理"
        ...
        {
          id: 3,
          prescription_id: 10082,
          prescription_code: "022026062802",
          patient_name: "李娜",
          doctor_name: "王医生",
          medicine_name: "复方草珊瑚含片",
          quantity: 3,
          prescription_status: "pending",
        ...
        {
          id: 4,
          prescription_id: 10083,
          prescription_code: "032026062703",
          patient_name: "王勇",
          doctor_name: "陈医生",
          medicine_name: "盐酸二甲双胍片",
          quantity: 2,
          prescription_status: "approved", // HIS已通过状态 → 显示"已发放处方"
          created_at: new Date(Date.now() - 1000 * 60 * 25).toISOString(),
        },
        {
          id: 5,
          prescription_id: 10084,
          prescription_code: "012026062504",
          patient_name: "赵敏",
          doctor_name: "刘医生",
          medicine_name: "板蓝根颗粒",
          quantity: 5,
      ...
      stats.value = {
        total: 5,
        pending: 3,    // HIS待审核处方数 → 显示为"待处理处方"
        approved: 2,   // HIS已通过处方数 → 显示为"已发放处方"
        dispensed: 0
      }
    }
    error.value = ''
